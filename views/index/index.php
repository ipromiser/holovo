                                    ...
                                    <li class="yamm-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="dropdown-banner-holder">
                                                <a href="#"><img alt="" src="/holovo/web/assets/images/banners/banner-side.png" /></a>
                                            </div>
                                        </div>
                                        <!-- ================================== MEGAMENU VERTICAL ================================== -->
                                    </li>
        ...
        <div class="col-xs-12 col-sm-8 col-md-9 homebanner-holder">
            ...
            <div id="hero">
                <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                    ...
                    <div class="item" style="background-image: url(/holovo/web/assets/images/sliders/slider01.jpg);">
                    ...
                    <!--<div class="item" style="background-image: url(/holovo/web/assets/images/sliders/slider02.jpg);">
                        <div class="container-fluid">
                            <div class="caption vertical-center text-left">
                                <div class="big-text fadeInDown-1">
    ...
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
            <a href="category-grid.html">
                ...
                <img class="banner-image" alt="" src="/holovo/web/assets/images/blank.gif" data-echo="/holovo/web/assets/images/banners/banner-narrow-01.jpg" />
            </a>
        </div>
        <div class="col-xs-12 col-lg-6 no-margin text-right banner">
            <a href="category-grid.html">
                ...
                <img class="banner-image" alt="" src="/holovo/web/assets/images/blank.gif" data-echo="/holovo/web/assets/images/banners/banner-narrow-02.jpg" />
            </a>
        </div>
    </div><!-- /.container -->
        ...
        <div class="carousel-holder" >
            ...
            <div id="owl-brands" class="owl-carousel brands-carousel">
                ...
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/holovo/web/assets/images/brands/brand-01.jpg" />
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/holovo/web/assets/images/brands/brand-02.jpg" />
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/holovo/web/assets/images/brands/brand-03.jpg" />
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/holovo/web/assets/images/brands/brand-04.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
